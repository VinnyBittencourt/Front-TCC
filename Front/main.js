$(document).ready(function () {
    ...
    //Button that makes a GET request to the Flask API
    $("#btn-procedure").click(async function (e) {
        e.preventDefault();
        console.log("cli");
        const respon = await fetch("http://127.0.0.1:5000/", {
